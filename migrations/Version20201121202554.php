 ...
 */
final class Version20201121202554 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dispose (id INT AUTO_INCREMENT NOT NULL, animal_id INT NOT NULL, personne_id INT NOT NULL, nb INT NOT NULL, INDEX IDX_6262E0668E962C16 (animal_id), INDEX IDX_6262E066A21BD112 (personne_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
